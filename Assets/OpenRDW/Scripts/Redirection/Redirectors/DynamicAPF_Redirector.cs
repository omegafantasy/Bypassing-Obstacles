...
public class DynamicAPF_Redirector : APF_Redirector
{
    ...
    //     if (Vector2.Dot(n, d.normalized) > 0)
    //         return (q - p).magnitude * d.normalized * 1 / Mathf.Pow(d.magnitude, 1);
    //     else
    //         return Vector2.zero;
    // }
    ...
    public void ApplyRedirectionByForce(Vector2 force, List<SingleSpace> physicalSpaces)
    {
        ...
        // var distToObstacle = Utilities.GetNearestDistToObstacleAndTrackingSpaces(physicalSpaces, redirectionManager.currPosReal);
