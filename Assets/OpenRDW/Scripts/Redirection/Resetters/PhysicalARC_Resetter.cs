...
public class PhysicalARC_Resetter : Resetter
{
    ...
    public override void InjectResetting()
    {
        ...
        else
        {
            ...
            // if (movementManager.avatarId == 1)
            // {
            //     Debug.Log("steerRotation:" + steerRotation + "requiredRotateAngle:" + requiredRotateAngle + "requiredRotateSteerAngle:" + requiredRotateSteerAngle);
            // }
